...
resource "aws_iam_role" "csp_reports_task_execution_role" {
  name               = "csp_reports_execution_role"
  assume_role_policy = data.aws_iam_policy_document.csp_reports_task_execution_role.json
...
data "aws_iam_policy_document" "csp_reports_task_execution_role" {
  statement {
    effect = "Allow"
...
resource "aws_iam_role_policy_attachment" "ecs_task_execution_policy" {
  role       = aws_iam_role.csp_reports_task_execution_role.name
...
data "aws_iam_policy_document" "csp_reports_policies" {
  statement {
    ...
    resources = [
      "arn:aws:ssm:ca-central-1:${var.account_id}:parameter/csp_reports/config",
